    ...
    <>
      <article className="flex flex-col gap-y-6 pb-6 border-dark/40 border-b-2">
        <h1 className="mb-0 text-4xl lg:text-5xl">
          Hey! I&apos;m Atul, a proud developer who builds things with
          computers.
        </h1>
      ...
      <article className="flex-col gap-y-4 py-4 w-full">
        ...
        <article className="gap-6 grid grid-cols-2 lg:grid-cols-3 w-full">
      ...
      <article className="flex-col gap-y-4 py-4 w-full">
        <div className="flex items-center mb-3" id="certifications">
      ...
      <article className="flex-col gap-y-4 py-4 w-full">
        ...
        <p>
          ...
          from you. <a href="mailto:atulpatidar1709@gmail.com">Email me</a> or get
          in touch on socials.
        </p>
      </article>
    </>
